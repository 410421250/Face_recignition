...
* 王泰翔：這次的人臉辨識最難的地方我認為是資料預處理的部分，將資料做成model可以輸入的形狀耗費了最多的時間，反而調整model的訓練是製作過程中最有趣味的部分，但是處理資料的過程卻是學習到最多技術及觀念的地方，電腦安裝keras和cuda也是有一些困難要克服，完成之後，訓練的速度有了飛躍的提升， 結論就是，cuda千萬不要安裝最新版的，這是實驗出來的結果。
